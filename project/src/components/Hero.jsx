...
export function Hero() {
  ...
  const scrollToWork = () => {
    try {
      ...
      if (!workSection) {
        console.error('Work section not found in DOM');
        return;
      }
  ...
  return (
    <section 
      ...
      style={{ position: 'relative', pointerEvents: 'auto' }} // Ensure pointer events work
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <div 
              ...
              style={{ animation: 'fadeInUp 1s ease-out 0.4s both', pointerEvents: 'auto' }}
            >
              <a
